...
public class Main {
	...
	// write your code here
        ...
        studentStream.printHighestPercentStudents();
        studentStream.printDeptCount();
        studentStream.averagePercentageInDepts();
        studentStream.youngestMaleStudent("Electrical");
        studentStream.printGenderCountInDept("Computer Science");
    }
}
